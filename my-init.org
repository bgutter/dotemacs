...
#+BEGIN_SRC emacs-lisp
    ...
    ;;  (package-require 'company-lsp)           ; LSP support in company completion
      ...
      (package-require 'gptel)                 ; Support for GPT conversation buffers & API calls
      (package-require 'org-ai)                ; Support for ChatGPT in #+BEGIN_AI blocks, and so much more
      (package-require 'pyvenv)                ; Python virtual environments
