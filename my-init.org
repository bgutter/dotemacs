...
#+begin_src emacs-lisp
  ...
  (require 'org-roles)             ; Manage contributor relationships for tasks in org-mode and org-ql
  (unless-on-windows
...
#+BEGIN_SRC emacs-lisp
  ...
  (general-define-key :prefix my:shortcut-leader
                      ...
                      ;; "ot" -> Org Todo
                      "ota"              'org-roles-assign
                      "otA"              'org-roles-unassign
...
#+begin_src emacs-lisp
  ...
  (defun my:org-hashtags-all ()
    (let ((results (my:read-lines-from-file my:org-hashtags-file)))
      (setq org-roles-known-handles results) ;; hack as I transition code into org-roles
      results))
#+end_src
