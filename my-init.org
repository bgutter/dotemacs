      ...
      '(("x" "Combined Task List"
         ...
         ((org-ql-block '(todo "WAIT")
                        ((org-ql-block-header "Blocked (tag is WAIT)")
                         (org-super-agenda-groups '((:name none :priority "A")
                                                    (:name none :priority "B")
                                                    (:name none :priority "C")
                                                    (:name none :priority "D")
                                                    (:name none :priority "E")))))
          ...
          (org-ql-block '(and (todo "TODO")
                        ...
                        ((org-ql-block-header "Priority Personal Backlog (#[A-C] or Due Soon, and, Not Delegated)")
                         (org-super-agenda-groups '((:name none :priority "A")
                                                    (:name none :priority "B")
                                                    (:name none :priority "C")
                                                    (:name none :priority "D")
          ...
          (org-ql-block '(and
                           (todo "ASSIGNED" "TODO" "BACKLOG")
                           (property "ASSIGNEE"))
                        ((org-ql-block-header "All Open & Delegated Tasks by Assignee")
          ...
          (org-ql-block '(and (todo "TODO")
                              ...
                              (and (priority "D" "E")
                                   (not (deadline auto)))
                              (not (tags "NOAGENDA" "UNFILED" "ARCHIVE")))
                        ((org-ql-block-header "Low Priority Backlog by Category (#[D-E], Not Due Soon, and Not Delegated)")
