...
#+BEGIN_SRC emacs-lisp
        ...
        (defun my:org-refile-as-journal (arg)
          "Refile current heading to today's journal page. With prefix arg, file as action item."
          (interactive "P")
          (org-mark-ring-push)
          (jay/refile-to (my-org-journal-make-if-missing)
                         (if (equal arg '(4))
                             "Action Items"
                           "Thoughts"))
          (org-mark-ring-goto))
