...
#+begin_src emacs-lisp
  (setq org-agenda-super-agenda-mode t)
      ...
      `(("x" "Combined Task List"
         ((tags "WAIT"
          ...
          (org-ql-block '(and (todo "TODO")
                        ...
                        ((org-ql-block-header "Personal Backlog")
                         (org-super-agenda-groups '((:name "Emergency" :priority "A")
                                            (:name "Must Do" :priority "B")
                                            (:name "Should Do" :priority "C")
                                            (:auto-category t)))))
          ...
          (todo "BACKLOG"
                ((org-agenda-overriding-header "Assignable Backlog"
                 :group "Backlog")))))))
#+end_src
