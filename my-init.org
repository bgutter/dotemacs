...
Replace the default directive.

#+begin_src emacs-lisp
    (setq gptel-directives (cons `(default .
                                           ,(mapconcat 'identity
                                                       '("You are a large language model living in Emacs. Please respond concisely and be terse. Do not be overly nice or wordy, just get to the point. Assume that your conversation partner has technical competence, and does not need their hand held or their ego massaged."
                                                       ...
                                                       "\n"))
                                 (assq-delete-all 'default gptel-directives)))
#+end_src
